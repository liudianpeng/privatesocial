...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('resource', $e, $a, $b));
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('picture', $e, $a, $b));
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('avatar', $e, $a, $b));
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\InjectListener('avatar', $e, $a, $b));
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('resource', $e, $a, $b));
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('avatar', $e, $a, $b));
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('avatar', $e, $a, $b));
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('resource', $e, $a, $b));
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('picture', $e, $a, $b));
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\InjectListener('picture', $e, $a, $b));
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\InjectListener('resource', $e, $a, $b));
        $f->addEventSubscriber(new \FOS\UserBundle\Doctrine\Orm\UserListener($this));
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('picture', $e, $a, $b));

        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_pgsql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'avshare', 'user' => 'avshare', 'password' => 'avshare123', 'charset' => 'UTF8', 'driverOptions' => array()), $d, $f, array());
    }
    ...
    /**
     * Gets the 'elfinder_loader' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \FM\ElfinderBundle\Loader\FMElfinderLoader A FM\ElfinderBundle\Loader\FMElfinderLoader instance.
     * 
     * @throws InactiveScopeException when the 'elfinder_loader' service is requested while the 'request' scope is not active
     */
    ...
    /**
     * Gets the 'simple_things_form_extra.form.type.file_set' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \SimpleThings\FormExtraBundle\Form\Type\FileSetType A SimpleThings\FormExtraBundle\Form\Type\FileSetType instance.
     * 
     * @throws InactiveScopeException when the 'simple_things_form_extra.form.type.file_set' service is requested while the 'request' scope is not active
     */
    ...
    /**
     * Gets the 'simple_things_form_extra.form.type.image' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \SimpleThings\FormExtraBundle\Form\Type\ImageType A SimpleThings\FormExtraBundle\Form\Type\ImageType instance.
     */
    ...
    /**
     * Gets the 'simple_things_form_extra.form.type.plain' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \SimpleThings\FormExtraBundle\Form\Type\PlainType A SimpleThings\FormExtraBundle\Form\Type\PlainType instance.
     */
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'FMElfinderBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
        ...
        $instance->addGlobal('siteName', 'PrivateSocial');
        $instance->addGlobal('siteTagline', 'This is a PrivateSocial Website');
    ...
    /**
     * Gets the 'twig.extension.fm_tinymce_init' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \FM\ElfinderBundle\Twig\Extension\FMElfinderTinymceExtension A FM\ElfinderBundle\Twig\Extension\FMElfinderTinymceExtension instance.
     */
