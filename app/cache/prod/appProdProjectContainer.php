...
class appProdProjectContainer extends Container
{
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'simple_things_form_extra.form.type.file_set' => 'getSimpleThingsFormExtra_Form_Type_FileSetService',
            'simple_things_form_extra.form.type.image' => 'getSimpleThingsFormExtra_Form_Type_ImageService',
            'simple_things_form_extra.form.type.plain' => 'getSimpleThingsFormExtra_Form_Type_PlainService',
            ...
            'trsteel_ckeditor.form.type' => 'getTrsteelCkeditor_Form_TypeService',
            'twig' => 'getTwigService',
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/vagrant/avshare/app/cache/prod/annotations', false);
    }
    protected function getAssetic_AssetManagerService()
    {
        $a = $this->get('templating.loader');
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig'), $this->get('monolog.logger.assetic', ContainerInterface::NULL_ON_INVALID_REFERENCE)), new \Assetic\Cache\ConfigCache('/vagrant/avshare/app/cache/prod/assetic/config'), false)));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $d->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('resource', $c, $a, $b));
        $d->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('picture', $c, $a, $b));
        $d->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('avatar', $c, $a, $b));
        $d->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\InjectListener('avatar', $c, $a, $b));
        $d->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('resource', $c, $a, $b));
        $d->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('avatar', $c, $a, $b));
        $d->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('avatar', $c, $a, $b));
        $d->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('resource', $c, $a, $b));
        $d->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('picture', $c, $a, $b));
        $d->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\InjectListener('picture', $c, $a, $b));
        $d->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\InjectListener('resource', $c, $a, $b));
        $d->addEventSubscriber(new \FOS\UserBundle\Doctrine\Orm\UserListener($this));
        $d->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('picture', $c, $a, $b));
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_pgsql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'avshare', 'user' => 'avshare', 'password' => 'avshare123', 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), $d, array());
    }
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_default_02c5c9477c3ae764dec947ca7227bf07a7bb8bfe80d026db18861a1dcbe0b0ed');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_02c5c9477c3ae764dec947ca7227bf07a7bb8bfe80d026db18861a1dcbe0b0ed');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_02c5c9477c3ae764dec947ca7227bf07a7bb8bfe80d026db18861a1dcbe0b0ed');
        ...
        $e->setProxyDir('/vagrant/avshare/app/cache/prod/doctrine/orm/Proxies');
    ...
    protected function getElfinderLoaderService()
    {
        ...
        return $this->services['elfinder_loader'] = $this->scopedServices['request']['elfinder_loader'] = new \FM\ElfinderBundle\Loader\FMElfinderLoader(array('locale' => 'zh_CN', 'editor' => 'ckeditor', 'fullscreen' => true, 'include_assets' => true, 'compression' => false, 'connector' => array('debug' => true, 'roots' => array('uploads' => array('driver' => 'LocalFileSystem', 'path' => 'assets', 'upload_allow' => array(0 => 'image/png', 1 => 'image/jpg', 2 => 'image/jpeg'), 'upload_deny' => array(0 => 'all'), 'upload_max_size' => '10M', 'showhidden' => false, 'relative_url' => false))), 'tinymce_popup_path' => ''), $this->get('request'));
    }
    ...
    {
        return $this->services['exercise_html_purifier.cache_warmer.serializer'] = new \Exercise\HTMLPurifierBundle\CacheWarmer\SerializerCacheWarmer(array(0 => '/vagrant/avshare/app/cache/prod/htmlpurifier'));
    }
    protected function getExerciseHtmlPurifier_Config_DefaultService()
    {
        return $this->services['exercise_html_purifier.config.default'] = call_user_func(array('HTMLPurifier_Config', 'create'), array('Cache.SerializerPath' => '/vagrant/avshare/app/cache/prod/htmlpurifier'));
    }
    ...
    {
        return $this->services['liip_imagine.cache.signer'] = new \Liip\ImagineBundle\Imagine\Cache\Signer('adfasdfkasdfasf');
    }
    ...
    {
        return $this->services['liip_imagine.filter.configuration'] = new \Liip\ImagineBundle\Imagine\Filter\FilterConfiguration(array('avatar_image' => array('quality' => 75, 'filters' => array('thumbnail' => array('size' => array(0 => 128, 1 => 128), 'mode' => 'outbound')), 'format' => NULL, 'animated' => false, 'cache' => NULL, 'data_loader' => NULL, 'default_image' => NULL), 'small_face_image' => array('quality' => 75, 'filters' => array('thumbnail' => array('size' => array(0 => 50, 1 => 60), 'mode' => 'outbound')), 'format' => NULL, 'animated' => false, 'cache' => NULL, 'data_loader' => NULL, 'default_image' => NULL), 'face_image' => array('quality' => 75, 'filters' => array('thumbnail' => array('size' => array(0 => 250, 1 => 300), 'mode' => 'outbound')), 'format' => NULL, 'animated' => false, 'cache' => NULL, 'data_loader' => NULL, 'default_image' => NULL)));
    }
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('/vagrant/avshare/app/logs/prod.log', 100, true);
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $g = new \Symfony\Component\HttpFoundation\RequestMatcher('^/avid/login$');
        ...
        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/account');
        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/avshare');
        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('^/avshare/admin');
        ...
        $m->add($j, array(0 => 'ROLE_USER'), NULL);
        $m->add($k, array(0 => 'ROLE_USER'), NULL);
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/vagrant/avshare/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/vagrant/avshare/app/cache/prod/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    protected function getSimpleThingsFormExtra_Form_Type_FileSetService()
    {
        if (!isset($this->scopedServices['request'])) {
            throw new InactiveScopeException('simple_things_form_extra.form.type.file_set', 'request');
        }
        return $this->services['simple_things_form_extra.form.type.file_set'] = $this->scopedServices['request']['simple_things_form_extra.form.type.file_set'] = new \SimpleThings\FormExtraBundle\Form\Type\FileSetType();
    }
    ...
    protected function getSimpleThingsFormExtra_Form_Type_PlainService()
    {
        return $this->services['simple_things_form_extra.form.type.plain'] = new \SimpleThings\FormExtraBundle\Form\Type\PlainType();
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('avshare');
        $a->setPassword('avshare');
        $a->setAuthMode(NULL);
    ...
    protected function getTemplating_Helper_LogoutUrlService()
    {
        ...
        $instance->registerListener('main', '/avid/logout', 'logout', '_csrf_token', NULL);
        return $instance;
    }
    ...
    {
        return $this->services['time.datetime_formatter'] = new \Knp\Bundle\TimeBundle\DateTimeFormatter($this->get('translator.default'));
    }
    ...
    {
        $this->services['translator.default'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, new \Symfony\Component\Translation\MessageSelector(), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => '/vagrant/avshare/app/cache/prod/translations', 'debug' => false));
    ...
    protected function getTrsteelCkeditor_Form_TypeService()
    {
        ...
        $instance->addTransformer(new \Exercise\HTMLPurifierBundle\Form\HTMLPurifierTransformer($this->get('exercise_html_purifier.default')), 'html_purifier');
        return $instance;
    }
    protected function getTwigService()
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/vagrant/avshare/app/cache/prod/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\FormExtension(new \Symfony\Bridge\Twig\Form\TwigRenderer(new \Symfony\Bridge\Twig\Form\TwigRendererEngine(array(0 => 'SimpleThingsFormExtraBundle:Form:div_layout.html.twig', 1 => 'form_div_layout.html.twig', 2 => 'LiipImagineBundle:Form:form_div_layout.html.twig', 3 => 'TrsteelCkeditorBundle:Form:ckeditor_widget.html.twig')), $this->get('form.csrf_provider', ContainerInterface::NULL_ON_INVALID_REFERENCE))));
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), false, array(), array(0 => 'FMElfinderBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('adfasdfkasdfasf');
    }
    ...
    {
        return $this->services['vich_uploader.upload_handler'] = new \Vich\UploaderBundle\Handler\UploadHandler($this->get('vich_uploader.property_mapping_factory'), $this->get('vich_uploader.storage'), $this->get('vich_uploader.file_injector'), $this->get('event_dispatcher'));
    }
    protected function getAssetic_AssetFactoryService()
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/vagrant/avshare/app/../web', false);
    }
    ...
    protected function getTemplating_Engine_PhpService()
    {
        ...
        $instance->setHelpers(array('slots' => 'templating.helper.slots', 'assets' => 'templating.helper.assets', 'request' => 'templating.helper.request', 'session' => 'templating.helper.session', 'router' => 'templating.helper.router', 'actions' => 'templating.helper.actions', 'code' => 'templating.helper.code', 'translator' => 'templating.helper.translator', 'form' => 'templating.helper.form', 'stopwatch' => 'templating.helper.stopwatch', 'logout_url' => 'templating.helper.logout_url', 'security' => 'templating.helper.security', 'assetic' => 'assetic.helper.static', 'knp_pagination' => 'knp_paginator.templating.helper.pagination', 'time' => 'time.templating.helper.time', 'vich_uploader' => 'vich_uploader.templating.helper.uploader_helper', 'imagine' => 'liip_imagine.templating.helper'));
        return $instance;
    }
    protected function getTemplating_LocatorService()
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/vagrant/avshare/app/cache/prod');
    }
    ...
    protected function getVichUploader_MetadataReaderService()
    {
        ...
        $b->setCache(new \Metadata\Cache\FileCache('/vagrant/avshare/app/cache/prod/vich_uploader'));
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/vagrant/avshare/app/cache/prod',
            ...
            'kernel.bundles' => array(
                ...
                'SimpleThingsFormExtraBundle' => 'SimpleThings\\FormExtraBundle\\SimpleThingsFormExtraBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'avshare',
            'database_user' => 'avshare',
            'database_password' => 'avshare123',
            ...
            'session.save_path' => '/vagrant/avshare/app/cache/prod/sessions',
            ...
            'router.resource' => '/vagrant/avshare/app/config/routing.yml',
            ...
            'twig.form.resources' => array(
                0 => 'SimpleThingsFormExtraBundle:Form:div_layout.html.twig',
            ...
            'twig.options' => array(
                ...
                'cache' => '/vagrant/avshare/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'avshare',
            'swiftmailer.mailer.default.transport.smtp.password' => 'avshare',
            'swiftmailer.mailer.default.transport.smtp.auth_mode' => NULL,
            'swiftmailer.mailer.default.transport.smtp.timeout' => 30,
            'swiftmailer.mailer.default.transport.smtp.source_ip' => NULL,
            'swiftmailer.spool.default.memory.path' => '/vagrant/avshare/app/cache/prod/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/vagrant/avshare/app/cache/prod/assetic',
            ...
            'doctrine.orm.proxy_dir' => '/vagrant/avshare/app/cache/prod/doctrine/orm/Proxies',
            ...
            'trsteel_ckeditor.ckeditor.contents_css' => array(
            ),
            ...
            'trsteel_ckeditor.ckeditor.custom_config' => NULL,
            ...
            'exercise_html_purifier.cache_warmer.serializer.paths' => array(
                0 => '/vagrant/avshare/app/cache/prod/htmlpurifier',
            ),
