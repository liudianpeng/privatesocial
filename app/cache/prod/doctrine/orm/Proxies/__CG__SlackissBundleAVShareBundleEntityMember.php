 ...
 */
class Member extends \Slackiss\Bundle\AVShareBundle\Entity\Member implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'uid', 'created', 'modified', 'status', 'remark', 'username', 'password', 'email', '' . "\0" . 'Slackiss\\Bundle\\AVShareBundle\\Entity\\Member' . "\0" . 'avatar', '' . "\0" . 'Slackiss\\Bundle\\AVShareBundle\\Entity\\Member' . "\0" . 'avatarAttach', 'usernameCanonical', 'emailCanonical', 'enabled', 'salt', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt');
        }
    ...
    public function setAvatarAttach($avatarAttach)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAvatarAttach', array($avatarAttach));

        return parent::setAvatarAttach($avatarAttach);
    }
    ...
    public function getAvatarAttach()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAvatarAttach', array());

        return parent::getAvatarAttach();
    }
